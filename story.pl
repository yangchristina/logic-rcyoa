...
choice(scene(1), 1, "Throw away the crown. What rubbish!", [scene(2), scene(11)], 1).
choice(scene(1), 2, "Love frogs, so you agree to save them, but secretly collect information about them so you can betray the butterflies later", [scene(4)], -1).
choice(scene(1), 3,"Point your sword to the sky, and declare you will save the butterflies, and destroy the frogs!", [scene(4), scene(10), scene(3), scene(5)], 9).
choice(scene(1), 4, "As a seasoned ruler, you calmly order the butterflies to bring you a plate of jelly beans.", [scene(2)], 7).
...
choice(scene(2), 1, "'Of course! They will pay for this great humiliation!'", [scene(4), scene(3)], 7).
choice(scene(2), 2, "'Destroy them? Never! They've already destroyed me!'", [scene(11), scene(9), scene(5)], 2).
choice(scene(2), 3, "'Will I be paid? Is this job? My greatest strength is that I will sell my soul to be employed.'", [scene(3), scene(4), scene(5)], 5).
choice(scene(2), 4, "'DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS. DEATH TO THE FROGS.'", [scene(3), scene(5)], 9).
...
choice(scene(3), 1, "Turn back, nope, this dark forest is not for meeeee", [scene(1), scene(9), scene(11)], 2).
choice(scene(3), 2, "Send butterfly scouts deep into the woods, but it does not seem likely that they will return", [scene(10.5)], -3).
choice(scene(3), 3, "Bravely forge ahead.", [scene(5)], 8).
choice(scene(3), 4, "The frogs will protect me I will be safe.", [scene(5), scene(2)], 1).
...
choice(scene(4), 1, "Wow, this lamp seems useful", [scene(3)], 8).
choice(scene(4), 2, "I need nothing but my own courage and skills", [scene(5)], 6).
choice(scene(4), 3, "Give me everything you offer", [scene(5)], 4).
choice(scene(4), 4, "Money, money, money, MONEYYYYYYY!!!!!", [scene(5)], 10).

scene_desc(scene(5), "You've run into a giant frog henchman. What will you do next?").
choice(scene(5), 1, "Flee. My life is not worth this.", [scene(11), scene(10.5), scene(9)], 1).
choice(scene(5), 2, "Sacrifice the butterflies. Hey, I've got more important things to do", [scene(10.5), scene(10), scene(6), scene(8)], -5).
choice(scene(5), 3, "Prepare for battle. Even though I've spent everyday job searching... Wish me luck.", [scene(6), scene(10), scene(7)], 8).
choice(scene(5), 4, "Prepare for battle! I've got this!", [scene(8), scene(6), scene(7)], 8).
choice(scene(5), 5, "I can convince this frog that I'm on his side.", [scene(7), scene(6), scene(8)], 6).
...
choice(scene(6), 1, "No matter, I am prepared to move forward", [scene(10), scene(5), scene(10.5)], 8).
choice(scene(6), 2, "Oh no, I've got to turn back and recoup", [scene(9), scene(11)], 4).
choice(scene(6), 3, "Speed up to apprehend the henchman again", [scene(3), scene(5), scene(10), scene(10.5)], 7).
choice(scene(6), 4, "I'm on the frogs' side? Why should I stop it. Pretend to accidentally let it go.", [scene(10), scene(10.5)],-1).
...
choice(scene(9), 1, "I'm going back home, it's not worth it! Send me home!", [scene(11), end()], 1).
...
choice(scene(10), 1, "Fight! I will never give up", [end()], 7).
choice(scene(10), 2, "Surrender, frogs are too scary. I'm sorry, butterflies, but I can't!", [end()], -10).
choice(scene(10), 3, "Is it too late to run away?", [end()], 2).
choice(scene(10), 4, "I've prepared this long, I guess I'll do my best.", [end()], 7).
...
choice(scene(10.5), 1, "Fight! I will never give up", [end()], 7).
choice(scene(10.5), 2, 'Surrender, frogs are too scary. I\'m sorry, butterflies, but I can\'t!', [end()], -100).
choice(scene(10.5), 3, "Is it too late to run away?", [end()], (-2)).
choice(scene(10.5), 4, "I've prepared this long, I guess I'll do my best.", [end()], 7).
...
choice(scene(11), 1, "Stay", [end(*)], 1).                 % game will end
choice(scene(11), 2, "Continue the adventure", [scene(3)], 1).  % game continues
choice(scene(11), 3, "Go home", [end()], 1).                % game will end
